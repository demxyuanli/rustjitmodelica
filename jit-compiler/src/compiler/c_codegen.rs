...
use super::equation_convert::{expr_substitute_all_array_indices, parse_array_index};
...
fn collect_external_calls_with_signature(
    eqs: &[Equation],
    ctx: &CCodegenContext,
