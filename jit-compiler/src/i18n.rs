...
fn template(lang: Lang, key: &str) -> &'static str {
    let (en, zh) = match key {
        ...
        "clocked_states" => (" * Number of clocked states: {}{}", " * \u{65f6}\u{949f}\u{72b6}\u{6001}\u{6570}: {}{}"),
        "clock_partitions_count" => (" * Clock partitions: {}", " * \u{65f6}\u{949f}\u{5206}\u{533a}\u{6570}: {}"),
        "clock_partition_vars" => (" *   [{}]{}", " *   [{}]{}"),
