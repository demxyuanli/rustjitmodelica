...
export function SimulationPanel({
  ...
  return (
    <div className="h-[200px] border-t border-border flex flex-col shrink-0 overflow-hidden bg-surface-alt">
      ...
      <div className="flex-1 min-h-0 flex">
        <div className="w-1/2 border-r border-border overflow-auto p-1 text-xs font-mono">
